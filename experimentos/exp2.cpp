...
*/
void experimentoBT1(int min_size, int max_size, int granularity)
{
	/* 
	...
	*/
	...
	for (int i = min_size; i < max_size+1; i+=granularity)
	{
		...
		for (int j = 0; j < NUMERO_MUESTRAS; ++j)
		{
			...
			solucionBacktracking(v, sum_w/5);
	...
	ofstream outfile;
	outfile.open("exp_bt_1.csv", ios::out);
...
/* 
   ...
   * Capacidad máxima: 2*(suma de todos los costos) y
                       suma de la mitad de todos los costos
*/
void experimentoBT2(int min_size, int max_size, int granularity)
{
	/* 
	   Acá voy a guardar el tiempo promedio que tarda el algoritmo
	   para cada tamaño de vector.
	...
	*/
	...
	// Guardo los resultados en un archivo de texto
	ofstream outfile;
	outfile.open("exp_bt_2.csv", ios::out);
...
/* 
   ...
   * Capacidad máxima: 2*(suma de todos los costos) y
                       suma de la mitad de todos los costos
*/
void experimentoBT3(int min_size, int max_size, int granularity)
{
	/* 
	   Acá voy a guardar el tiempo promedio que tarda el algoritmo
	   para cada tamaño de vector.
	...
	*/
	...
	// Guardo los resultados en un archivo de texto
	ofstream outfile;
	outfile.open("exp_bt_3.csv", ios::out);
...
/* 
   ...
   * Capacidad máxima: 2*(suma de todos los costos) y
                       suma de la mitad de todos los costos
*/
void experimentoBT4(int min_size, int max_size, int granularity)
{
	/* 
	   Acá voy a guardar el tiempo promedio que tarda el algoritmo
	   para cada tamaño de vector.
	...
	*/
	...
	// Guardo los resultados en un archivo de texto
	ofstream outfile;
	outfile.open("exp_bt_4.csv", ios::out);
...
/* 
   ...
   * Capacidad máxima: 2*(suma de todos los costos) y
                       suma de la mitad de todos los costos
*/
void experimentoBT5(int min_size, int max_size, int granularity)
{
	/* 
	   Acá voy a guardar el tiempo promedio que tarda el algoritmo
	   para cada tamaño de vector.
	...
	*/
	...
	// Guardo los resultados en un archivo de texto
	ofstream outfile;
	outfile.open("exp_bt_5.csv", ios::out);
...
/* 
   ...
   * Capacidad máxima: 2*(suma de todos los costos) y
                       suma de la mitad de todos los costos
*/
void experimentoBT6(int min_size, int max_size, int granularity)
{
	/* 
	   Acá voy a guardar el tiempo promedio que tarda el algoritmo
	   para cada tamaño de vector.
	...
	*/
	...
	// Guardo los resultados en un archivo de texto
	ofstream outfile;
	outfile.open("exp_bt_6.csv", ios::out);
...
{
	printf("%s\n", "Empiezando BT1...");
	experimentoBT1(1, 28, 1);
	printf("%s\n", "Terminé! :)");

	printf("%s\n", "Empiezando BT2...");
	experimentoBT2(1, 28, 1);
	printf("%s\n", "Terminé! :)");

	printf("%s\n", "Empiezando BT3...");
	experimentoBT3(1, 28, 1);
	printf("%s\n", "Terminé! :)");

	printf("%s\n", "Empiezando BT4...");
	experimentoBT4(1, 28, 1);
	printf("%s\n", "Terminé! :)");

	printf("%s\n", "Empiezando BT5...");
	experimentoBT5(1, 28, 1);
	printf("%s\n", "Terminé! :)");

	printf("%s\n", "Empiezando BT6 ..");
	experimentoBT6(1, 28, 1);
	printf("%s\n", "Terminé! :)");
